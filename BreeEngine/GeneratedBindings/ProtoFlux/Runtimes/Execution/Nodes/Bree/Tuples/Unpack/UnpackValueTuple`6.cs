// <auto-generated/>
/* *******************************
Generated for type: ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple`6
...
namespace FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack
{
    ...
    [Grouping("Core.Operators.UnpackTuple6")]
    [Category("ProtoFlux/Runtimes/Execution/Nodes/Tuples/Unpack")]
    public  partial class UnpackValueTuple<T0, T1, T2, T3, T4, T5> : global::FrooxEngine.ProtoFlux.Runtimes.Execution.VoidNode<global::FrooxEngine.ProtoFlux.FrooxEngineContext>
        
         where T0 : unmanaged where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged
    {
        public override Type NodeType => typeof(global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5>);

        public static bool IsValidGenericType => global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5>.IsValidGenericType;

        
public global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5> TypedNodeInstance { get; private set;}
...
public override N Instantiate<N>()
{
                ...
                var node = new global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5>();
...
{
    if(node is global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5> typedNode)
    {
        ...
        throw new ArgumentException("Node instance is not of type " + typeof(global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Unpack.UnpackValueTuple<T0, T1, T2, T3, T4, T5>));
}
...
case 5: return Value5;
		...
		public readonly SyncRef<global::FrooxEngine.ProtoFlux.INodeValueOutput<global::System.ValueTuple<T0, T1, T2, T3, T4, T5>>> Tuple;
