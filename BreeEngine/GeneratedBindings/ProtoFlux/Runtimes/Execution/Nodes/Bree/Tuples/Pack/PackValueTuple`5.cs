// <auto-generated/>
/* *******************************
Generated for type: ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple`5
...
namespace FrooxEngine.ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack
{
    ...
    [Grouping("Core.Operators.PackTuple5")]
    [Category("ProtoFlux/Runtimes/Execution/Nodes/Tuples/Pack")]
    public  partial class PackValueTuple<T0, T1, T2, T3, T4> : global::FrooxEngine.ProtoFlux.Runtimes.Execution.ValueFunctionNode<global::FrooxEngine.ProtoFlux.FrooxEngineContext, global::System.ValueTuple<T0, T1, T2, T3, T4>>
        
         where T0 : unmanaged where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged
    {
        public override Type NodeType => typeof(global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4>);

        public static bool IsValidGenericType => global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4>.IsValidGenericType;

        
public global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4> TypedNodeInstance { get; private set;}
...
public override N Instantiate<N>()
{
                ...
                var node = new global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4>();
...
{
    if(node is global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4> typedNode)
    {
        ...
        throw new ArgumentException("Node instance is not of type " + typeof(global::ProtoFlux.Runtimes.Execution.Nodes.Bree.Tuples.Pack.PackValueTuple<T0, T1, T2, T3, T4>));
}
